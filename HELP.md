...
* The original package name 'net.the-code-strangers.Galvanize-MovieDatabase-API' is invalid and this project uses 'net.thecodestrangers.GalvanizeMovieDatabaseAPI' instead.
